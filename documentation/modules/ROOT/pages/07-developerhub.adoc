...
* After register, you'll get username, password, and URL for access to each component.
+
...
* Click on `scaffolders-templates` directory. We will begin creating a software component based on the `quarkus-web-template` - Quarkus Service with ArgoCD and a Tekton Pipeline.
+
image::devhub/dh-7.png[]

* Click on `quarkus-web-template` diretory.
+
