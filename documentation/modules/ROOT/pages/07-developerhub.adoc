...
* Select `my-quarkus-app-gitops` project to view all artifacts for applcation deployment with GitOps.
+
image::devhub/dh-72.png[]
image::devhub/dh-70.png[]

* Go back to RHDH web console, nn the *Run of quarkus-web-template* wizard screen click on *SOpen Component in catalog* link.
+
