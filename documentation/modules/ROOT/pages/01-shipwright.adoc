...
* Open the OpenShift web console URL from the registration page.

image::setup/registration-02.png[]

* login with your username and password get from the registration page.
+
