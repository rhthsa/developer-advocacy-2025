...
In this lab, our applications are hosted on a private Git repository. Follow these steps to get access to the *gitea* Git repository server.
...
* Enter the Git repository URL you've copied to *Git Repo URL* input.
