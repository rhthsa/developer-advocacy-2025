...
* Register with your email address and password `openshift` to access the lab.
+
...
In this lab, we are going to build application container from the code hosted on a Git repository. Follow these steps to build and deploy the applcation using OpenShift Builds in combination of Shipwright and Buildah.
