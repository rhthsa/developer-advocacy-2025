...
- [Boost developer Productivity with Developer Hub](#boost-developer-productivity-with-developer-hub)
  ...
  - [Technical Storytelling - Golden Path](#technical-storytelling---golden-path)
  - [Golden Path with Red Hat Developer Hub Software Templates Library](#golden-path-with-red-hat-developer-hub-software-templates-library)
  - [Review Software Template in this lab.](#review-software-template-in-this-lab)
  - [Create Project from Software Template](#create-project-from-software-template)
  - [Start Development with RHDH](#start-development-with-rhdh)
  - [Deploy to Prepod](#deploy-to-prepod)
